...
public static class LanguageLayouts
{
    public static Dictionary<int, List<int>> DistanceCodeKey = new Dictionary<int, List<int>>
        {
            /* '`' */ { 192 , new List<int>(){ 49 }},
        ...
        /// <summary>
        /// Codes to Russian language layout
        /// </summary>
        public static Dictionary<char, int> CodeKeysRus = new Dictionary<char, int>
        {
            { 'ё' , 192  },
            { '1' , 49  },
            { '2' , 50  },
        ...
        /// <summary>
        /// Codes to English language layout
        /// </summary>
        public static Dictionary<char, int> CodeKeysEng = new Dictionary<char, int>
        {
            { '`', 192 },
            { '1', 49   },
            { '2', 50   },
        ...
        /// <summary>
        /// Trransliteration from English to Russian => ASCII (ISO 9-95)
        /// </summary>
        public static Dictionary<char, string> TransliterationRusToEng = new Dictionary<char, string>
        {
            { 'а', "a" },
            { 'б', "b" },
            { 'в', "v" },
